...
const variantStyles = {
  ...
  secondary:
    'bg-transparent text-text border border-border-strong hover:bg-interactive-subtle active:bg-interactive-muted focus-visible:ring-1 focus-visible:ring-interactive-border/50',
  tertiary:
